...
-- 6. Get Username and account balance of the 3 users with the lowest balances, sort lowest to highest.
SELECT "username", "account_balance" FROM "syntax_practice"
...
-- 8. Add a new record.
INSERT INTO
"syntax_practice" ("username", "city", "transactions_attempted", "account_balance")
VALUES ('chris', 'Minneapolis', '1', '10000', '1000000.00');
...
'pheonix') AND "transactions_completed" < 5;
